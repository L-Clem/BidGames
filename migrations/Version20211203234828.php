 ...
 */
final class Version20211203234828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, bid_id INT DEFAULT NULL, street_number SMALLINT NOT NULL, street_name VARCHAR(255) NOT NULL, address_complement VARCHAR(255) DEFAULT NULL, country VARCHAR(255) NOT NULL, INDEX IDX_D4E6F81AE80F5DF (department_id), UNIQUE INDEX UNIQ_D4E6F814D9866B8 (bid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE auction_house (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_28C1A094F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, auctioneer_id INT DEFAULT NULL, deposit_address_id INT DEFAULT NULL, estimation NUMERIC(10, 2) DEFAULT NULL, for_sale TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, invisble_for VARCHAR(255) NOT NULL, INDEX IDX_232B318C7E3C61F9 (owner_id), INDEX IDX_232B318C2533C6D7 (auctioneer_id), INDEX IDX_232B318CBC4CBC (deposit_address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sale_bid (id INT AUTO_INCREMENT NOT NULL, bid_id INT NOT NULL, sale_id INT NOT NULL, sold TINYINT(1) NOT NULL, starting_price NUMERIC(10, 2) NOT NULL, sold_at_price NUMERIC(10, 2) DEFAULT NULL, reserve_price NUMERIC(10, 2) NOT NULL, INDEX IDX_62054C424D9866B8 (bid_id), INDEX IDX_62054C424A7E4868 (sale_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
